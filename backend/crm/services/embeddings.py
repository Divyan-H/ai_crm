...
# Persist the model inside the service directory (git-ignored) so it isn't
# re-downloaded from temp. Override with EMBED_CACHE_DIR.
_CACHE_DIR = os.environ.get("EMBED_CACHE_DIR") or os.path.join(
